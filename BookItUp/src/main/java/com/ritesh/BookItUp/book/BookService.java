...
import com.ritesh.BookItUp.common.PageResponse;
import com.ritesh.BookItUp.exception.OperationNotPermittedException;
import com.ritesh.BookItUp.file.FileStorageService;
import com.ritesh.BookItUp.history.BookTransactionHistory;
import com.ritesh.BookItUp.history.BookTransactionHistoryRepository;
...
public class BookService {
    ...
    public Integer borrowBook(Integer bookId, Authentication connectedUser) {
        Book book = bookRepository.findById(bookId)
                .orElseThrow(() -> new EntityNotFoundException("No book is found with the ID: " + bookId));
